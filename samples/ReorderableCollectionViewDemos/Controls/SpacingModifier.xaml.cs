...
using ReorderableCollectionViewDemos.Helpers;
...
namespace ReorderableCollectionViewDemos.Controls
{
    public partial class SpacingModifier : ContentView
    {
        ...
        void OnUpdateButtonClicked(object sender, EventArgs e)
        {
            ...
            else if (CV.ItemsLayout is VariableSpanGridItemsLayout variableSpanLayout)
            {
                variableSpanLayout.VerticalItemSpacing = indexes[0];
                variableSpanLayout.HorizontalItemSpacing = indexes[1];
            }
        }
